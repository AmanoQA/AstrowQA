...
public class LoginTests extends ExtentManager {
    ...
    public void loginTestHR() {
        ...
        //this.writeLog.get().info("Check if Logout button is displayed and \"Hello, hr\" is displayed");
        assertTrue(loginPage.checkAccount("hr"));
    ...
    public void loginTestAdministrator() {
        ...
        assertTrue(loginPage.checkAccount("administrator"));
